...
xUnit.net is part of the [.NET Foundation](https://www.dotnetfoundation.org/) and operates under a [code of conduct](/code-of-conduct). It is licensed under [Apache 2](https://opensource.org/licenses/Apache-2.0) (an OSI approved license). The project is [governed](/governance) by a Project Lead.
...
|                                                 | Stable                                             | Prerelease
| ----------------------------------------------- | -------------------------------------------------- | ----------
| Core Framework v3                               | [4.0.0](/releases/v3/4.0.0){: .release }           | _None_
| Core Framework v2 <sup>[[1](#footnote-1)]</sup> | [2.9.3](/releases/v2/2.9.3){: .release }           | _None_
| Analyzers                                       | [2.0.0](/releases/analyzers/2.0.0){: .release }    | _None_
| Visual Studio adapter                           | [4.0.0](/releases/visualstudio/4.0.0){: .release } | _None_
...
| `xunit` <sup>[[1](#footnote-1)]</sup> | [![](https://img.shields.io/nuget/v/xunit.svg?logo=nuget)](https://www.nuget.org/packages/xunit)                                         | _N/A_                                                                                                                                                                                                                         | [![](https://img.shields.io/endpoint.svg?url=https://actions-badge.atrox.dev/xunit/xunit/badge%3Fref%3Dv2&amp;label=build)](https://actions-badge.atrox.dev/xunit/xunit/goto?ref=v2)
...
1. <a id="footnote-1"></a>Core Framework v2 is in maintenance mode. Critical bug fixes will be issued, but no new feature work is being done. All new features are taking place with Core Framework v3 only. Developers are encouraged to upgrade from v2 to v3 at their earliest convenience.
