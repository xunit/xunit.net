...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported via GitHub to [`@bradwilson`](https://github.com/bradwilson). All complaints will be reviewed and investigated promptly and fairly.
...
This Code of Conduct is based on the [.NET Foundation Code of Conduct](https://dotnetfoundation.org/about/policies/code-of-conduct), which itself is based on [Contributor Covenant 2.0](https://www.contributor-covenant.org/version/2/0/code_of_conduct.html) and [Mozilla’s code of conduct enforcement ladder](https://github.com/mozilla/diversity).

LLM / AI prohibitions are based on the [Zig Code of Conduct](https://ziglang.org/code-of-conduct/).
