...
analyzer: true
title: xUnit1058
description: Generic collection definitions are not supported in Native AOT
severity: Error
v2: false
v3: false
aot: true
...
public class xUnit1058<T> : ICollectionFixture<MyFixture<T>>
{ }
```
...
[CollectionDefinition]
public class xUnit1058 : ICollectionFixture<MyFixture<int>>
{ }
```
